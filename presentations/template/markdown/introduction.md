...
<p class="fragment">with <strong>179 chapters</strong> world-wide that have organized <strong>759 events</strong> (and counting).</p>
...
<div class="hosts">
	<a class="host">
		<img src="https://avatars2.githubusercontent.com/u/3767167?v=4&s=460">
	...
	<a class="host">
		...
		<span>Daan&nbsp;Houweling</span>
		<i class="twitter">@daanpeer</i>
	</a>
	<a class="host">
...
http://nodeschool.io/utrecht/code-of-conduct <!-- .element: class="fragment"  -->
